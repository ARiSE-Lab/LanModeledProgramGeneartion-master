...
print('train_batches: ', len(train_batches), len(train_batches[0]), train_batches[0][0].sentence1, train_batches[0][0].target )# , train_batches[0][0].sentence1)
...
train = train.Train(model, corpus.max_sent_length, corpus.dictionary, embeddings_index, 'CrossEntropyLoss')
